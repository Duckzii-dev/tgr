...
export default function MuscleRecoveryMap({ recovery = [] }) {
  ...
  const nextReady = useMemo(() => {
    if (!groupsByStatus.recovering.length) return null;
    return [...groupsByStatus.recovering].sort(
                ...
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="text-right">
                    <div
                      ...
                      style={{
                        color: recoverySolid(activeData.percent, activeNever),
                      }}
                    >
